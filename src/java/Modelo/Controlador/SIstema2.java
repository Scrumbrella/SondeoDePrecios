 ...
 * @author Nahum
 */
public class SIstema2 extends HttpServlet {
    ...
    private void mostrarCategorias(PrintWriter out) {
        out.println(controladorCategoria.mostrarCategorias());
    }

    private void getDescCategoria(int idCategoria, PrintWriter out) {
        out.println(controladorCategoria.getDescCategoria(idCategoria));
    }
